...
namespace TrackRecordAPI.Migrations
{
    ...
    [Migration("20210105054549_ChangedUpdatedTimeColumnType")]
    partial class ChangedUpdatedTimeColumnType
    {
            ...
            modelBuilder.Entity("TrackRecordAPI.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StudentId = 1,
                            DOB = new DateTime(2021, 1, 5, 5, 45, 47, 700, DateTimeKind.Utc).AddTicks(6654),
                            FirstName = "Ritesh",
                            IsUpdated = false,
                            LastName = "Joshi",
                            StudentAge = 22
                        ...
                        {
                            StudentId = 2,
                            DOB = new DateTime(2021, 1, 5, 5, 45, 47, 700, DateTimeKind.Utc).AddTicks(8123),
                            FirstName = "Amit",
                            IsUpdated = false,
                            LastName = "Joshi",
                            StudentAge = 20
