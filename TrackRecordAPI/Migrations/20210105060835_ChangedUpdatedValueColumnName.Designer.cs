...
namespace TrackRecordAPI.Migrations
{
    ...
    [Migration("20210105060835_ChangedUpdatedValueColumnName")]
    partial class ChangedUpdatedValueColumnName
    {
            ...
            modelBuilder.Entity("TrackRecordAPI.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StudentId = 1,
                            DOB = new DateTime(2021, 1, 5, 6, 8, 34, 658, DateTimeKind.Utc).AddTicks(3787),
                            FirstName = "Ritesh",
                            IsUpdated = false,
                            LastName = "Joshi",
                            StudentAge = 22
                        ...
                        {
                            StudentId = 2,
                            DOB = new DateTime(2021, 1, 5, 6, 8, 34, 658, DateTimeKind.Utc).AddTicks(4659),
                            FirstName = "Amit",
                            IsUpdated = false,
                            LastName = "Joshi",
                            StudentAge = 20
