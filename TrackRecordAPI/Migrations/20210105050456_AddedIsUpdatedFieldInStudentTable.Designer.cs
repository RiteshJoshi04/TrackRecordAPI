...
namespace TrackRecordAPI.Migrations
{
    ...
    [Migration("20210105050456_AddedIsUpdatedFieldInStudentTable")]
    partial class AddedIsUpdatedFieldInStudentTable
    {
            ...
            modelBuilder.Entity("TrackRecordAPI.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StudentId = 1,
                            DOB = new DateTime(2021, 1, 5, 5, 4, 54, 940, DateTimeKind.Utc).AddTicks(1143),
                            FirstName = "Ritesh",
                            IsUpdated = false,
                            LastName = "Joshi",
                            StudentAge = 22
                        ...
                        {
                            StudentId = 2,
                            DOB = new DateTime(2021, 1, 5, 5, 4, 54, 940, DateTimeKind.Utc).AddTicks(2472),
                            FirstName = "Amit",
                            IsUpdated = false,
                            LastName = "Joshi",
                            StudentAge = 20
